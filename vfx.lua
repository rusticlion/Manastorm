...
function VFX.resetEffect(effect)
    ...
    effect.coneAngle = nil
    effect.coneLength = nil
    effect.waveCount = nil
    effect.waveSpeed = nil
    effect.motionStyle = nil
    effect.waveCrest = nil
    effect.waveCrestSize = nil
    effect.focusedCore = nil
    effect.options = nil
...
function VFX.createEffect(effectName, sourceX, sourceY, targetX, targetY, options)
    ...
    effect.coneAngle = template.coneAngle
    effect.coneLength = template.coneLength
    effect.waveCount = template.waveCount
    effect.waveSpeed = template.waveSpeed
    effect.motionStyle = template.motionStyle
    effect.waveCrest = template.waveCrest
    effect.waveCrestSize = template.waveCrestSize
    effect.focusedCore = template.focusedCore
